  ...
  if (type === "faculty") {
    content = (
      <div>
        <div className="flex justify-between">
          ...
          <button
            onClick={StudentInfo}
            className="text-white  bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-3 py-2 text-center items-center"
          >
            Get Info
          </button>
        </div>
        ...
        <div className={`flex justify-between ${fshow ? "" : "hidden"}`}>
          <button
            onClick={approve}
    ...
    content = (
      <div className={` p-5`}>
        ...
        <div className={`flex justify-between ${hshow ? "" : "hidden"}`}>
          <button
            onClick={approve}
            className="text-white  bg-green-500 hover:bg-green-600 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center"
          >
